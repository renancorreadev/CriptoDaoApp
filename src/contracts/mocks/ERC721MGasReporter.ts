...
export interface ERC721MGasReporterInterface extends utils.Interface {
  functions: {
...
export interface ERC721MGasReporter extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC721MGasReporterInterface;
